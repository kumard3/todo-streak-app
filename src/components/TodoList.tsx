...
const TodoList: React.FC<TodoListProps> = ({
  ...
  return (
    <ul>
      {todos.map((todo) => {
        const currentStreak = calculateStreak(todo, currentDate);
        const longestStreak = Math.max(currentStreak, todo.longestStreak);
          ...
          <li key={todo.id}>
            ...
            <button
              onClick={() => {
                ...
                updateTodoSettings(todo.id, { longestStreak });
              }}
            >
              Complete
            </button>
